...
class _AdminRegistrationState extends State<AdminRegistration> {
  ...
  final List<String> roles = ['Admin', 'Super Admin'];
  ...
  Future<void> saveAdmin() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('users').doc(adminId).set({
        ...
        'role': selectedRole!.toLowerCase().replaceAll(" ", "_"), // admin / super_admin
        'created_at': FieldValue.serverTimestamp(),
      });
      ...
      showCustomAlert(
        ...
        isSuccess: false,
        title: 'Error',
        description: 'Failed to register admin: $e',
      );
    }
  }
